    ...
    _In_ int       nCmdShow)
{
    ...
    if (mainGame)
        mainGame->Init();
    SetTimer(g_hWnd, TIMER_ID, 70, NULL);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(szWindowClass, _T("Crazy Arcade"), WS_OVERLAPPEDWINDOW,
        200, 200, 815, 657, nullptr, nullptr, hInstance, nullptr);
